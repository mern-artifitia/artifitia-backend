...
const { register, login, editProfile, addFund,withdrawFund,profile,forgotPassword,verifyOtp,allUsers, addSpread,getSpread } = require("../controller/user");
...
router.post("/addSpread", authUser, addSpread);
